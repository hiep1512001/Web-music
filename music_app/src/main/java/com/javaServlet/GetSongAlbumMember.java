...
@WebServlet(urlPatterns={"/GetSongAlbumMember"})
public class GetSongAlbumMember extends HttpServlet{

    private static final long serialVersionUID = 1L;

    public GetSongAlbumMember() {
        super();
    }
    @Override
...
//            errorString = e.getMessage();
        ...
        RequestDispatcher dispatcher = request.getServletContext()
                .getRequestDispatcher("/WEB-INF/views/user/getAlbumMember.jsp");
